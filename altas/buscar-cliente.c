...
#line 13 "buscar-cliente.cbl"
  ENTRY_BUSCAR__CLIENTE:	cob_nop ();
#line 120 "buscar-cliente.c"

  /* Line: 13        : DISPLAY            : buscar-cliente.cbl */
#line 13 "buscar-cliente.cbl"
  cob_nop ();
#line 125 "buscar-cliente.c"
  cob_display (0, 1, 1, &c_1);

  /* Line: 14        : MOVE               : buscar-cliente.cbl */
#line 14 "buscar-cliente.cbl"
  cob_nop ();
#line 131 "buscar-cliente.c"
  memset (b_18, 48, 6);

  /* Line: 15        : GOBACK             : buscar-cliente.cbl */
#line 15 "buscar-cliente.cbl"
  cob_nop ();
#line 137 "buscar-cliente.c"
  goto exit_program;
